  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Station icon
          Image.asset("asset/home/bookicon.png", height: 100, width: 100),
          ...
          if (currentPosition != null)
            Text(
              '${mapService.calculateDistance(currentPosition!.latitude, currentPosition!.longitude, station.position.latitude, station.position.longitude).toStringAsFixed(1)} km away',
